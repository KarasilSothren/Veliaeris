...
namespace VeliaerisMod.Modules
{
    public class VoidDetonatorOrb : Orb
    {
        ...
        public override void OnArrival()
        {
            ...
            body.RemoveBuff(VeliaerisBuffs.abyss);
...
//            this.modelAnimator = healthComponent.GetComponent<Animator>();
            ...
            if (healthComponent.combinedHealthFraction < voidExecution)
            {
                ...
                Util.PlayAttackSpeedSound("Play_nullifier_death", healthComponent.body.gameObject, 1.5f);
                EffectManager.SpawnEffect(voidExecute, new EffectData
                {
                    origin = position,
        ...
        public GameObject voidExecute = Resources.Load<GameObject>("prefabs/effects/nullifierdeathexplosion");
