...
{
    public class BasicScytheSlashWithReductions : BaseMeleeAttack
    {
     //   private OverlapAttack attack;
        ...
        public override void OnEnter()
        {
            ...
            Reduction = Util.CheckRoll(15f, this.body.master);
            if (Reduction)
            {
                attack.AddModdedDamageType(DamageTypes.armorVoid);
            }
