...
using VeliaerisMod.Survivors.Henry.SkillStates;
using R2API;
using RoR2;
using RoR2.Skills;
using System;
...
namespace VeliaerisMod.Survivors.Henry
{
    public class VeliaerisSurvivor : SurvivorBase<VeliaerisSurvivor>
    {
        ...
        public const string HENRY_PREFIX = VeliaerisPlugin.DEVELOPER_PREFIX + "_HENRY_";
        ...
        private void RecalculateStatsAPI_GetStatCoefficients(CharacterBody sender, R2API.RecalculateStatsAPI.StatHookEventArgs args)
        {
            ...
            if (sender.HasBuff(VeliaerisBuffs.armorBuff))
            {
                args.armorAdd += 300;
            }
            if (sender.HasBuff(VeliaerisBuffs.buffOfAzelythtsa))
            {
                args.baseAttackSpeedAdd += 20;
                args.baseDamageAdd += 50;
                args.baseMoveSpeedAdd += 10;
                args.baseHealthAdd += 100;
            }
        ...
        public static float DotIntervalAbyssBleed = 0.5f;
        public static float DotIntervalAbyssCollapse = 1.0f;
        public static float DotDuration = 100f;
    }
}
