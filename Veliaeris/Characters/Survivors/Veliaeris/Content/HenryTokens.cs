...
namespace VeliaerisMod.Survivors.Veliaeris
{
    public static class HenryTokens
    {
        ...
        public static void AddHenryTokens()
        {
            ...
            #region Passive
            Language.Add(prefix + "PASSIVE_NAME", "General passive");
            Language.Add(prefix + "VELIAERIS_NAME", "Veliaeris passive");
            Language.Add(prefix + "ERIS_NAME", "Eris passive");
            Language.Add(prefix + "VELIA_NAME", "Velia passive");
