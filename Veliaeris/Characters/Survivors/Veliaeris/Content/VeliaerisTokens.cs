...
namespace VeliaerisMod.Survivors.Veliaeris
{
    public static class VeliaerisTokens
    {
        ...
        public static void AddVeliaerisTokens()
        {
            ...
            Language.Add(prefix + "SKILL_INFORMATION", "<style=cKeywordName>Stagnat Skills</style>All Skills are Persona specfic the selection of skills is display only and will not affect what skils the survivor will use in what form. Their purpose is to give a view into what each form can do.");
            #endregion
